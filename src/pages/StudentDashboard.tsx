...
import { Calendar, Users, Clock, TrendingUp, Home, LogOut, User } from "lucide-react";
  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <div className="container mx-auto px-4 py-8">
        {/* Welcome */}
        <div className="mb-8">
          <h2 className="text-3xl font-bold text-foreground mb-2">Welcome back, Alex Thompson!</h2>
          <p className="text-muted-foreground">Discover exciting events happening around campus.</p>
        </div>
